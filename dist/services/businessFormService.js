...
exports.getDepartmentColumn = getDepartmentColumn;
exports.getDepartment = getDepartment;
exports.getEmployee = getEmployee;
exports.getSalesRecord = getSalesRecord;
exports.dynamicGetBusinessFormColumn = dynamicGetBusinessFormColumn;
// 导入 mysql2/promise
...
async function getDepartmentColumn() {
    try {
 ...
 * 动态获取业务表表头
 */
async function dynamicGetBusinessFormColumn(tableName) {
    try {
        ...
        const result = businessFormColumn.map((column) => {
            return {
                field: column.Field,
...
//# sourceMappingURL=businessFormService.js.map